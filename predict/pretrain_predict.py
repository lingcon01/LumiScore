...
sys.path.append(os.path.abspath(__file__).replace("pretrain_predict.py", ".."))
...
def Input():
    ...
    p.add_argument('-m', '--model',
                   ...
                   help='/home/suqun/tmp/GMP/pretrain/EGMDN/ET_pretrain.pth"')
...
def scoring(prot, lig, modpath,
    ...
    _, _, preds = run_an_eval_epoch(model, test_loader, dist_threhold=kwargs['dist_threhold'],
...
def main():
    ...
    ids, preds = scoring(prot=inargs.prot, lig=inargs.lig, modpath=inargs.model, cut=inargs.cutoff,
    ...
    df.to_csv("./pretrain_fragment_2200.csv")
